...
The student handbook code is on github [here](https://github.com/LucyMcGowan/handbook). You can contribute by starting a new issue, modifying a page, or adding a new page.  See $\S$ \@ref(github) to get started with github.